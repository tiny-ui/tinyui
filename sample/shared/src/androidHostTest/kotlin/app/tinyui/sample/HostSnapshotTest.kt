...
class HostSnapshotTest {
    ...
    fun hostMatchesTheSnapshotOfItsHostVersion() {
        ...
        val current = HostSnapshot.render(sampleHost(), HOST_VERSION)
        ...
        assertEquals(emptyList(), HostSnapshot.problems(file.readText(), sampleHost(), HOST_VERSION), "the host is no longer one of ${file.path}; $hint")
    }
}
